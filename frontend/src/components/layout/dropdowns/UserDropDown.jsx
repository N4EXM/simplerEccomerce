...
const UserDropDown = () => {
    ...
    return (
        ...
        >
            ...
            <div
                className={`${tglDropDown ? 'flex' : 'hidden'} ${user === null ? 'w-64 h-fit' : 'w-64 h-fit'}  bg-white dark:bg-black absolute top-16 -right-10 shadow shadow-black/50 dark:shadow-gray rounded-md z-50`}
            >
                {
                    user === null
                    ?   <div
                        ...
                        >
                            ...
                            <div
                                className='flex w-full h-fit p-1'
                            >
                                <DarkModeToggle/>
                            </div>
                    ...
                    :   <div
                        ...
                        >
                            ...
                            >
                                <button
                                    className='flex flex-row items-center gap-2 w-full h-fit p-2 text-rose-500 dark:text-rose-500 dark:hover:bg-rose-500 dark:hover:text-white text-sm font-medium font-poppins hover:bg-rose-200 rounded duration-200'
