...
const ImageCard = ({ imageUrl, name, handleImages }) => {
    return (
        <div
            className='w-40 h-40 max-h-40 max-w-40 relative p-2 bg-white rounded-md'
        >
            <img    
                src={imageUrl} 
            ...
            <p
                className='absolute bottom-1 left-1 w-fit px-2 p-1 text-xs rounded bg-black/50 text-white font-medium'
            >
                {name}
            </p>
        </div>
