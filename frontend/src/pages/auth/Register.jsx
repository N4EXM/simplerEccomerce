...
const Register = () => {
    ...
    return (
        ...
        >
            ...
            {/* big picture thing */}
            <div
                className='col-span-3 dark:bg-green bg-darkGreen rounded-md flex flex-col items-start justify-between px-10 py-8 shadow shadow-black/50 dark:shadow-slate-950 relative'
            >
                ...
                {/* bottom part */}
                <div
                    className='flex flex-col gap-3 w-fit h-fit z-10'
                >
                    <h1
                ...
                {/* toggle theme btn */}
                <button
                    className='absolute z-20 bottom-5 right-5 dark:bg-black bg-white p-2 rounded-full text-darkGreen dark:text-green cursor-pointer'
            ...
            {/* form */}
            <div
                className='col-start-4 w-full h-full col-span-2 bg-white dark:bg-white/3 rounded-md p-16 py-18 flex flex-col gap-10 shadow-black/50 shadow'
            >
                ...
                >
                    ...
                    <p
                        className='font-medium text-darkGreen/70 dark:text-white/70'
                    >
                ...
                >
                    ...
                    >
                        ...
                        />
                        <button
                            className='text-darkGreen/80 dark:text-green/80 p-2 absolute top-7.5 right-1'
                        ...
                        <h6
                          className='text-sm text-gray dark:text-white/50'
                        >
                ...
                >
                    {/* Register button */}
                    <button
                      className='w-full h-fit p-2 bg-darkGreen hover:bg-darkGreen/90 dark:bg-green dark:hover:bg-green/70 rounded-md text-white font-semibold duration-200 '
                    >
                      Register
                    </button>
                    <Link
                      className='text-sm dark:text-white/50 text-black/70 w-full text-center hover:text-black dark:hover:text-Dpri duration-200'
                        to={'/Login'}
                    >
